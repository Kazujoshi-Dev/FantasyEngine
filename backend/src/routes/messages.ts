...
// POST a new message
router.post('/', authenticateToken, async (req: express.Request, res: Response) => {
...
router.post('/claim-return/:id', authenticateToken, async (req: express.Request, res: Response) => {
...
router.post('/bulk-delete', authenticateToken, async (req: express.Request, res: Response) => {
    const { type } = req.body;
    let query;
