...
export const LocationsTab: React.FC<LocationsTabProps> = ({ locations, onGameDataUpdate }) => {
  ...
  return (
    <div className="animate-fade-in">
        ...
        {editingLocation ? (
            <LocationEditor location={editingLocation} onSave={handleSaveLocation} onCancel={() => setEditingLocation(null)} isEditing={!!editingLocation.id} allLocations={locations} />
        ) : (
