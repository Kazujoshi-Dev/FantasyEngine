  ...
  return (
    <div className={`bg-slate-900/50 p-4 rounded-lg border ${borderColor} h-full`}>
      ...
      <div className="text-left text-sm space-y-1 text-gray-300">
        ...
        {isPlayer && (
            <p className="flex justify-between"><strong>{t('statistics.attacksPerTurn')}:</strong> <span>{(stats as CharacterStats).attacksPerRound}</span></p>
        )}
    ...
    return (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in">
            <div className="bg-slate-800 border border-slate-700 rounded-2xl shadow-2xl p-8 max-w-7xl w-full flex flex-col" style={{maxHeight: '90vh'}}>
                ...
                <div className="flex-grow flex gap-4 mb-6 overflow-hidden min-h-[300px]">
                ...
                <button
                    ...
                    className="mt-4 w-full bg-indigo-600 text-white font-bold py-3 rounded-lg text-lg hover:bg-indigo-700 transition-colors duration-200 shadow-lg disabled:bg-slate-600 disabled:cursor-not-allowed"
                >
