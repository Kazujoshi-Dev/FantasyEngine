...
// FIX: Ensure formData.rewards.itemRewards is an array before calling map by using optional chaining on the map call itself. This prevents calling .map on a non-array value.
...
// FIX: Ensure formData.rewards.resourceRewards is an array before calling map by using optional chaining on the map call itself.
...
// FIX: Ensure formData.rewards.lootTable is an array before calling map by using optional chaining on the map call itself.
