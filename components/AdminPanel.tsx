...
// FIX: Ensure formData.rewards.itemRewards is an array before calling map by guarding with `(... || [])`. This prevents calling .map on a non-array value.
...
// FIX: Ensure formData.rewards.resourceRewards is an array before calling map by guarding with `(... || [])`.
...
// FIX: Ensure formData.rewards.lootTable is an array before calling map by guarding with `(... || [])`.
