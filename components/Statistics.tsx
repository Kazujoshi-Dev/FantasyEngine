...
export const Statistics: React.FC = () => {
  ...
  if (!character || !baseCharacter || !gameData) return null; // Should be handled by App loader
  ...
  // FIX: The call to calculateDerivedStats was missing arguments. It now includes all necessary data from gameData and the character context.
