export default {
    ...
    quests: {
        ...
        notEnoughGold: 'Nie posiadasz wystarczająco złota.',
        notEnoughEssence: 'Nie posiadasz wystarczająco esencji.',
    ...
    admin: {
        ...
        maxEnemies: 'Max. Wrogów',
        maxEnemiesDesc: 'Maksymalna liczba wrogów, która może się pojawić. 0 dla nielimitowanej.',
        ...
        quest: {
            ...
            repeatableDesc: 'Ile razy zadanie może zostać ukończone? (1 dla jednorazowego, 0 dla nieskończonego)',
            itemRewards: 'Nagrody w Przedmiotach',
            resourceRewards: 'Nagrody w Surowcach',
            quantity: 'Ilość',
            types: {
                Kill: 'Zabij Wrogów',
        ...
        pvp: {
            ...
            protectionDuration: 'Czas Ochrony (minuty)',
