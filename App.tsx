    ...
    <LanguageContext.Provider value={{ lang: currentLanguage, t }}>
      <div className="flex h-screen font-sans">
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-10">
          ...
          {activeTab === Tab.Camp && <Camp character={playerCharacter} onToggleResting={handleToggleResting} onUpgradeCamp={handleUpgradeCamp} getUpgradeCost={getCampUpgradeCost} onCharacterUpdate={handleCharacterUpdate} />}
