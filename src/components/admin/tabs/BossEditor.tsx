                 ...
                 <div>
                    ...
                    {(formData.resourceLootTable || []).map((loot, index) => (
                         <div key={index} className="flex items-center gap-2 mb-2 p-2 bg-slate-800/50 rounded-md">
                            ...
                            <input type="number" placeholder={t('admin.chance')!} value={loot.weight} onChange={e => handleResourceLootChange(index, 'weight', e.target.value)} className="w-24 bg-slate-700 p-2 rounded-md" />
