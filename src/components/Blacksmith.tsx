                            ...
                            <>
                                <div className="flex justify-center items-start gap-4 my-2">
                                     <div className="flex-1">
                                        ...
                                        <ItemDetailsPanel item={selectedItem} template={selectedTemplate} affixes={affixes} showIcon={false} size="small" hideAffixes={true} compact={true} />
                                    </div>
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <ItemDetailsPanel item={{...selectedItem, upgradeLevel: (selectedItem.upgradeLevel || 0) + 1}} template={selectedTemplate} affixes={affixes} showIcon={false} size="small" hideAffixes={true} compact={true} />
                                    </div>
                                </div>
