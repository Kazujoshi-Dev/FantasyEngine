              ...
              <div className="bg-slate-900/40 p-4 rounded-xl flex flex-col gap-4">
               ...
               <div className="bg-slate-900/40 p-4 rounded-xl">
                ...
                <div className="space-y-1">
                  ...
                  <StatRow label={t('statistics.attacksPerRound')} value={<span className="font-mono text-base font-bold text-white">{previewCharacter.stats.attacksPerRound}</span>} description={t('statistics.attacksPerRoundDesc')} />
