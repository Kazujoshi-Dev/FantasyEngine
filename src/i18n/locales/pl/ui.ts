...
export default {
    ...
    camp: {
        ...
        workshop: {
            ...
            reforgeLevelReq: 'Wymagany Lvl 10',
            reforgeTabValues: 'Oszlifowanie (Wartości)',
            reforgeTabAffixes: 'Przekucie Magii (Afiksy)',
            reforgeValuesDesc: 'Losuje na nowo wartości liczbowe obecnych statystyk. Afiksy pozostają bez zmian.',
            reforgeAffixesDesc: 'Usuwa obecne afiksy i losuje nowe dla tego przedmiotu.',
            reforgeEmptyBackpack: 'Pusty plecak.',
            reforgeAction: 'Przekuj',
            reforgeSuccess: 'Przedmiot przekuty!',
            reforgeLocked: 'Ulepsz warsztat do poziomu 10, aby odblokować.',
