...
export default {
    sidebar: {
        ...
        options: 'Opcje',
        logout: 'Wyloguj',
        actionBlockedWarning: 'Ta akcja jest niemożliwa podczas odpoczynku lub podróżowania.',
    ...
    statistics: {
        ...
        strength: 'Siła',
        strengthDesc: 'Zwiększa obrażenia broni białej i zdrowie.',
        agility: 'Zręczność',
        agilityDesc: 'Zwiększa obrażenia dystansowe, szansę na unik i pancerz.',
        accuracy: 'Celność',
        accuracyDesc: 'Zwiększa szansę na trafienie krytyczne.',
        stamina: 'Wytrzymałość',
        staminaDesc: 'Zwiększa punkty życia.',
        intelligence: 'Inteligencja',
        intelligenceDesc: 'Zwiększa punkty many i obrażenia magiczne.',
        energy: 'Energia',
        energyDesc: 'Zwiększa maksymalną pulę energii.',
        luck: 'Szczęście',
        luckDesc: 'Zwiększa szansę na znalezienie rzadszych przedmiotów.',
        health: 'Punkty Życia',
        mana: 'Mana',
        ...
        blockChanceDesc: 'Szansa na całkowite zablokowanie ataku tarcza.',
    ...
    camp: {
        ...
        unavailableDuringTravel: 'Akcje w obozie are niedostępne podczas podróżowania.',
        chestTitle: 'Skrzynia',
